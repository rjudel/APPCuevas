...
public class ServicesFacadeException extends ApplicationException{
    ...
    /**
     * Constructor for ServicesFacadeException
     * @param msg - Message associated with the exception
     */
    public ServicesFacadeException(String msg) {
        super(msg);
        error = msg;
    }

    /**
     * Initializes a newly created <code>ServicesFacadeException</code> object.
     * @param	msg - the message associated with the Exception.
     * @param   cause - Throwable object
     */
    public ServicesFacadeException(String msg, Throwable cause) {
        super(msg, cause);
    }
